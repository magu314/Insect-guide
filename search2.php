...
//検索条件生成
 ...
 if(!empty($habitat)){
 	...
 	if(($habitat)=="街中"){
 		...
 		$where .=" $and low like '街中' || low like '$habitat' ";
 	}else if(($habitat)=="丘陵"){
 		$where .=" $and (low like '街中' || low like '平地' || low like '$habitat') && 
 				   (high like '山' || high like '低山' || high like '$habitat')";
 	}else if(($habitat)=="低山"){
 		$where .=" $and high like '$habitat' || high like '山' ";
 	}else if(($habitat)=="山"){
